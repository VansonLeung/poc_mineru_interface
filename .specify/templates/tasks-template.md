...
- [ ] T010 [P] Establish observability baseline (structured logging, metrics, health checks)
- [ ] T011 [P] Configure secrets management and dependency/CVE scanning pipeline
...
- [ ] T019 [US1] Add logging/metrics for user story 1 operations
